...
function convertSaveEntitiesToRegular(saveEntities, idProperty, idType, schema) {
    return saveEntities.map((e) => (Object.assign({ [Core_1.default.Instance.dsModule.KEY]: e.key }, convertDatastoreDataToRegular_1.convertDatastoreDataToRegularData(e.data, schema), (idProperty != null && { [idProperty]: idType === "string" ? e.key.name : e.key.id }))));
}
